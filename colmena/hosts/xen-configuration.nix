  ...
  services.cockpit = {
    ...
    settings = {
      WebService = {
        ...
        Origins = lib.mkForce "http://127.0.0.1:9090 https://127.0.0.1:9090 https://100.113.83.131 https://xen-cockpit.blue-edmontosaurus.ts.net https://100.85.206.102:9090 http://100.85.206.102:9090";
      };
    };
  };
